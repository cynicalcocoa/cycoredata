...
// CYCoreData
#define COCOAPODS_POD_AVAILABLE_CYCoreData
#define COCOAPODS_VERSION_MAJOR_CYCoreData 0
#define COCOAPODS_VERSION_MINOR_CYCoreData 1
#define COCOAPODS_VERSION_PATCH_CYCoreData 1
